...
internal object AgentModelClient {
    ...
    fun loadVisionConfig(): ModelConfig? {
        val runtimeJson = Prefs.getString(Prefs.Keys.AGENT_VISION_CONFIG_JSON)
        if (runtimeJson.isBlank()) return null
        return runCatching { json.decodeFromString<ModelConfig>(runtimeJson) }.getOrNull()
    }
